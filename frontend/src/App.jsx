...
export default function App(){
  ...
  return <><header className="header"><div className="brand"><span className="logo">▶</span><span>Fábrica TikTok</span><span className="brand-divider"/><span className="workspace-name">Estúdio da Micaela</span></div><span className="local-badge"><ShieldCheck size={15}/> {busy?'Salvando…':'Dados neste computador'}</span><button type="button" className="build-badge" disabled={busy||!c} onClick={()=>c&&choose('performance')}>Performance</button></header>
